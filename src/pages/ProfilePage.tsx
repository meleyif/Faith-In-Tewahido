...
import { User, Mail, Shield, BookOpen, Settings, LogOut } from "lucide-react";
    ...
    <div className="space-y-12 animate-fade-in max-w-3xl">
      ...
      <div className="bg-layer1 border border-gold-border p-8 flex flex-col sm:flex-row items-center sm:items-start gap-8">
        ...
        <div className="flex-1 text-center sm:text-left">
          <h3 className="font-serif text-2xl text-white mb-1">Dawit Endale</h3>
          <p className="font-mono text-xs text-muted mb-4">dawit.e@example.com</p>
          <div className="inline-flex items-center gap-2 border border-[#a569bd]/40 bg-[#a569bd]/10 px-3 py-1 font-mono text-[10px] text-[#a569bd] uppercase tracking-wider">
            <Shield className="w-3 h-3" /> High School Student
          </div>
        </div>
        <button className="bg-layer2 border border-gold-border px-4 py-2 font-mono text-xs text-muted hover:text-white transition-colors">
          Edit Profile
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-layer1 border border-gold-border p-6">
          ...
          <div className="space-y-4">
            <button className="w-full flex items-center justify-between text-white hover:text-gold transition-colors font-sans py-2 border-b border-white/5">
        ...
        <div className="bg-layer1 border border-gold-border p-6">
          ...
          <div className="space-y-4">
            ...
            <button className="w-full flex items-center gap-3 text-[#e74c3c] hover:text-[#c0392b] transition-colors font-sans py-2 mt-4">
